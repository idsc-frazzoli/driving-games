...
test_packages=driving_games_tests,preferences_tests,games_tests,games_zoo_tests,possibilities_tests,toy_games_tests,nash_tests
cover_packages=$(test_packages),driving_games,preferences,games,games_zoo,possibilities,toy_games,nash
