...
test_packages=driving_games_tests,preferences_tests,games_tests,sim_tests,possibilities_tests,crash_tests,trajectory_games_tests
cover_packages=$(test_packages),driving_games,preferences,games,games_zoo,possibilities,sim,crash,trajectory_games
