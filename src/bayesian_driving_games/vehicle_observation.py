...
from .structures import Lights, SE2_disc, BayesianVehicleState
...
class VehicleDirectObservations(Observations[BayesianVehicleState, VehicleObservation]):
    possible_states: Mapping[PlayerName, FrozenSet[BayesianVehicleState]]
    my_possible_states: FrozenSet[BayesianVehicleState]
    ...
    def get_observations(
        self, me: BayesianVehicleState, others: Mapping[PlayerName, BayesianVehicleState]
