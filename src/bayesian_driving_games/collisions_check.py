...
from .structures import SE2_disc, VehicleGeometry, BayesianVehicleState
...
def collision_check(
    poses: Mapping[PlayerName, BayesianVehicleState], geometries: Mapping[PlayerName, VehicleGeometry],
...
def get_vehicle_points(vs: BayesianVehicleState, vg: VehicleGeometry) -> FrozenSet[Coordinates]:
...
def get_resources_used(vs: BayesianVehicleState, vg: VehicleGeometry, ds: D) -> FrozenSet[Rectangle]:
