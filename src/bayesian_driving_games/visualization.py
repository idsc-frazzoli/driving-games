...
from .structures import VehicleActions, VehicleCosts, VehicleGeometry, BayesianVehicleState
...
class DrivingGameVisualization(
    GameVisualization[BayesianVehicleState, VehicleActions, VehicleObservation, VehicleCosts, Collision]
):
    ...
    def hint_graph_node_pos(self, state: BayesianVehicleState) -> Tuple[float, float]:
        w = -state.wait * D(0.2)
