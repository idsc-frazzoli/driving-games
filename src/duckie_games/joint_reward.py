...
from driving_games.collisions import Collision, IMPACT_FRONT

from duckie_games.collisions_check import collision_check
...
class IndividualJointReward(JointRewardStructure[DuckieState, DuckieActions, Collision]):
    def __init__(
        self,
        collision_threshold: float,
        geometries: Mapping[PlayerName, DuckieGeometry],
