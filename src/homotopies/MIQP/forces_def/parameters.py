...
class CarParams:
    ...
    n_ineq: int = (
        10  # number of inequality constraints generated by each intersection(2 for homotopy, 8 for binary variables)
    )
    C: np.ndarray = np.array([[0, 1, dt], [dt, 0, 1]])  # discretized dynamics C=[B,A], x_i+1 = Ax_i + Bu_i
