...
def get_homotopy_scenario() -> SimContext:
    ...
    x0_p2 = VehicleStateDyn(x=5, y=8, theta=arctan2(10, 5), vx=0.7, delta=0)
    ...
    return SimContext(
        ...
        models=models,
        players=players,
        param=SimParameters(dt=D("0.01"), dt_commands=D("0.1"), sim_time_after_collision=D(2), max_sim_time=D(8)),
    )
