...
def get_intersection_scenario(agent_type: str) -> SimContext:
    ...
    #x0_p2 = VehicleStateDyn(x=15, y=20, theta=deg2rad(160), vx=1.5, delta=0)
    models = {P1: VehicleModelDyn.default_car(x0_p1), P2: VehicleModelDyn.default_car(x0_p2)}
    ...
    return SimContext(
        ...
        models=models,
        players=players,
        param=SimParameters(dt=D("0.01"), dt_commands=D("0.1"), sim_time_after_collision=D(2), max_sim_time=D(14)),
    )
