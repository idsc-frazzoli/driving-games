...
from duckie_games_test.test_game_generation import duckie_vehicle_parameters, duckie_game_parameters, uncertainty_prob, uncertainty_sets
...
def test_duckie_game(duckie_vehicle_parameters, duckie_game_parameters, duckie_uncert_params):
    d = "out/duckie_game/"
    game_name = "Duckie Game"
    solver_name = "Test"
