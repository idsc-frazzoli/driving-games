...
def test_two_player_reference_game(duckie_game_parameters, duckie_uncert_params):
    """
    Same solution as in module driving_games.zoo generated by get_sim(), but using the Duckie structures
    """
    d = "out/two_player_ref_game/"
    game_name = "Two player reference game"
    solver_name = "Test"
