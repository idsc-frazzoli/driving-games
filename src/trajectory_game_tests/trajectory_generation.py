...
from trajectory_game import VehicleState, VehicleGeometry, BicycleDynamics, AllTrajectories
...
def generate_trajectory_graph() -> MultiDiGraph:
    ...
    vg = VehicleGeometry(w=1.0, lf=1.0, lr=1.0)
    dynamics = BicycleDynamics(v_max=15.0, v_min=5.0, st_max=math.pi / 4, vg=vg, u_acc=u_acc, u_dst=u_dst)
    state_init = VehicleState(x=0.0, y=0.0, th=math.pi / 2, v=10.0, st=0.0, t=0.0)
