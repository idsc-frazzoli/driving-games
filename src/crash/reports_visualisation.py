...
from sim.simulator_visualisation import SimVisualisationABC



def create_animation(file_path: str,
                     sim_context: SimContext,
                     sim_viz: SimVisualisationABC,
    ...
    def update_plot(frame=0):
        t: float = (frame * delta_time_steps)
    ...
    anim = FuncAnimation(
        ...
        frames=int(frame_count), blit=False, interval=dt)
