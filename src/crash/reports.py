...
def compute_damage_metrics(coll_report: CollisionReport, sim_context: SimContext):
    ...
    a_state = sim_log[a].states.at_interp(coll_report.at_time)
    # fixme investigate why .at fails, rounding errors in SimTime?!
    b_state = sim_log[b].states.at_interp(coll_report.at_time)
