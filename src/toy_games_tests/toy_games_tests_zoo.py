...
game1 = ToyGame(subgames=[G1, G2, G3, G4],
                desc="This game presents some corner cases")
...
game2 = ToyGame(subgames=[G1b, G2b, G3b, G4b],
                desc="This game shall have a unique clear solution")
