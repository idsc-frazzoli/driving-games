...
class MPCKinContFull:

    def __init__(self, params: MPCKinContFullParam = MPCKinContFullParam()):
        """
        ...
        self.params: MPCKinContFullParam = params
    ...
    def update_state(self, obs: X, speed_ref: float):
        ...
        mterm = self.params.state_mult * ((self.s - self.state_x) ** 2 + (y - self.state_y) ** 2) + \
                self.params.speed_mult * (self.v - speed_ref) ** 2
