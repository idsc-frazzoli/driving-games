...
def test_mpckin_dis():
    ...
    """Speed behavior"""
    mpc_param: NMPCLatKinDisPVParam = NMPCLatKinDisPVParam(n_horizon=n_horizon, t_step=t_step,
    ...
    mpc_controller = {"Name": "MPC Controller", "Controller": NMPCLatKinDisPV, "Parameters": mpc_param}
    """MPC Controller"""
