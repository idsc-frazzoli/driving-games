...
run-dg-experiments: build
	...
	docker run -it --user $$(id -u) \
		...
		--games "multilane_int_2p_sets","multilane_int_3p_sets","multilane_int_4p_sets","multilane_int_5p_sets" \
		--solvers "solver-2-pure-security_mNE-fact1-noextra","solver-2-pure-security_mNE-naive-noextra"
